...
function Footer() {
  return (
    <div className="w-full flex  justify-between h-screen bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between  uppercase">
        <div className="headings ">
          <h1 className="text-[6vw] uppercase font-semibold leading-none -mb-4 tracking-tight">
            eye-
          </h1>
          <h1 className="text-[6vw] uppercase font-semibold leading-none -mb-4 tracking-tight">
            opening
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] uppercase font-semibold leading-none -mb-4 tracking-tight">
          presentations
        </h1>
        <div className="dets mt-20">
          <h1>S:</h1>
          <a className=" block text-xl mt-8 font-light  " href="#">
            Facebook
          </a>
        ...
        <div className="dets mt-8">
          ...
          <a className=" block text-xl mt-5 font-light " href="#">
            30 Chukarina St
          </a>
          <a className=" block text-xl font-light " href="#">
            Lviv,Ukraine
        ...
        <div className='dets mt-8' >
          <h1>E:</h1>
            <a className=" block text-xl mt-5 font-light  "href="#">hello@ochi.design</a>
      </div>
      </div>
